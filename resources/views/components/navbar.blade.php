  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="flex h-16 items-center justify-between">
      <div class="flex items-center">
       ...
       <!-- <img class="h-8 w-8" src="{{ asset('images/Logo_fix.png') }}" alt="Your Company">  -->
          ...
          <div class="relative ml-3">
            <div>
              <button type="button" @click="isOpen = !isOpen" 
                ...
                <img class="h-8 w-8 rounded-full" src="{{ asset('images/Logo_fix.png') }}" alt="">
              </button>
            </div>
  ...
  <div x-show= "isOpen" class="md:hidden" id="mobile-menu">
    ...
    <div class="border-t border-gray-700 pb-3 pt-4">
      <div class="flex items-center px-5">
        ...
        <div class="ml-3">
          <div class="text-base font-medium leading-none text-white">Stasiun Meteorologi Maritim Ambon</div>
          <div class="text-sm font-medium leading-none text-gray-400">bmkg@go.id</div>
        </div>
